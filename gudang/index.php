...
<div data-role="page" >
	...
	<div class="container">
		<div class="login">
		<center><strong>Masuk Gudang</strong>
			<form id="loginForm" method="POST" action="login.php" data-ajax="false">
				<div data-role="fieldcontain">
					<label for="username">Nama pengguna:</label>
					<input type="text" name="username" id="username" value="" placeholder="masukkan nama pengguna" />
				</div>
		
				<div data-role="fieldcontain">
					<label for="password">Kata sandi: </label>
					<input type="password" data-clear-btn="true" name="password" id="password" value="" autocomplete="off" placeholder="masukkan kata sandi" />
				</div>
...
?>		
			<button data-theme="b" type="submit" id="submit">Masuk</button>
