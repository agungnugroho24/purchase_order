...
<div data-role="content" data-add-back-btn="true">
	...
	<?php
	$query = mysql_query("SELECT * from ms_barang where stok < 15");
	...
	?>
			...
			<li><a href="#" data-ajax="false">
				<h2>Nama barang: <?php echo $data['nama_brg'] ?></h2>
				<p><strong>Jumlah: <?php echo $data['stok'] ?></strong></p>
				<p class="ui-li-aside"><strong><?php echo $data['id_brg'] ?></strong></p>
				</a>
			</li>
