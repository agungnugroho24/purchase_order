...
$query="SELECT a.id_brg, sum(a.jml_brg) as jml, c.nama_unit, b.id_brg, b.nama_brg FROM trx_barang a LEFT JOIN ms_barang b ON a.id_brg=b.id_brg LEFT JOIN ms_unit c ON a.id_unit=c.id_unit WHERE tgl BETWEEN '$data_tanggal_mysql1' AND '$data_tanggal_mysql2' GROUP BY b.id_brg";
