...
$year=$_POST['select2'];
    ...
    $this->Cell(0,0.75,'LAPORAN PENGADAAN BARANG BULANAN',0,0,'C');
    $this->Ln();
...
$query="SELECT a.id_brg, sum(a.jml_brg) as jml, b.nama_brg FROM in_barang a LEFT JOIN ms_barang b ON a.id_brg=b.id_brg WHERE MONTHNAME(tgl)='$month' AND YEAR(tgl)='$year' GROUP BY b.id_brg";
