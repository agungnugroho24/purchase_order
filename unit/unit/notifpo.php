...
<div data-role="content" data-add-back-btn="true">
	<?php
	$query = mysql_query("SELECT * from spp order by tanggal desc");
	...
	?>
			...
			<li><a href="notif1po.php?id=<?php echo $id."&token=".$token; ?>" data-ajax="false">
				<h2><?php echo $tanggal4; ?></h2>
				<p><strong>Dari: PO</strong></p>
				<?php
				if ($data['acc'] == 'y')
				{
				?>
				<p><strong>Pesan: </strong> Permintaan barang Anda kami terima</p>
				<?php
				}else{
				?>
				...
				?>
					<p class="ui-li-aside"><strong><?php echo $data['tanggal'] ?></strong></p>
				</a>
			</li>
