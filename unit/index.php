...
password: $("#password").val()
 ...
 $.ajax({ 
     ...
     success: function(pesan){
         if(pesan == 'ok'){
             $("#message").html("<p class='berhasil' align='center'>Anda Berhasil Login<br>Halaman akan dialihkan dalam 2 detik...<meta http-equiv='refresh' content='2; url=unit/index.php'></p>");
         }else{
...
<div data-role="page" >
	...
	<div class="container">
		<div class="login">
		<center><strong>Masuk unit</strong>
