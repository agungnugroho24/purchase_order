	...
	<div data-role="content" data-add-back-btn="true">
		...
		<div data-role="navbar" data-iconpos="left" class="a">	
			...
			<article class="paper">	
				...
				<?php
				$query="SELECT a.id_brg, sum(a.jml_brg) as jumlah, b.id_brg, b.nama_brg FROM tmp_stba a LEFT JOIN ms_barang B ON a.id_brg=b.id_brg GROUP BY nama_brg ORDER BY b.id_brg";
