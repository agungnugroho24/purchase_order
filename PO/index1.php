...
<div data-role="page">
	...
	<div data-role="content">
		...
		<ul>
			...
			$a=$row['a'];
			?>
			<li><a href="index1.php?menu=purchase" data-icon="bullets" data-ajax="false">Purchase Order</a></li>
			<li><a href="index1.php?menu=notif" data-icon="bullets" data-ajax="false">Notifikasi</a></li>
