...
<div data-role="page" >
	...
	<div class="container">
		<div class="login">
		<center><strong>Masuk Purchasing Order</strong>
			<form id="loginForm" method="POST" action="login.php" data-ajax="false">
				<div data-role="fieldcontain">
					<label for="username">Username:</label>
					<input type="text" name="username" id="username" value="" placeholder="masukkan username" />
				</div>
		
				<div data-role="fieldcontain">
					<label for="password">Password: </label>
					<input type="password" data-clear-btn="true" name="password" id="password" value="" autocomplete="off" placeholder="masukkan password" />
				</div>
