				...
				<ul data-role="listview" data-inset="true">
					...
					?>
						   ...
						   <BR>
							...
							<?php
							$sql = mysql_query("SELECT a.id_brg,a.nama_brg,b.id_kategori,b.nama_kategori,a.stok FROM ms_barang a LEFT JOIN kategori b ON a.id_kategori=b.id_kategori ORDER BY a.id_brg LIMIT $offset, $dataPerPage");
							//$no=1;
							while ($data = mysql_fetch_array($sql))
							{
							?>
